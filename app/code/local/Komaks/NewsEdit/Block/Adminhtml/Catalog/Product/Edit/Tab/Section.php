 ...
 */
/**
 * Section tab on product edit form
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Block_Adminhtml_Catalog_Product_Edit_Tab_Section extends Komaks_NewsEdit_Block_Adminhtml_Section_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('komaks_newsedit/catalog/product/edit/tab/section.phtml');
    }
    ...
    /**
     * Return array with section IDs which the product is assigned to
     *
     * @access public
     * @return array
     * @author Ultimate Module Creator
    ...
    public function getSectionIds()
    {
        if (is_null($this->_sectionIds)) {
            $selectedSections = Mage::helper('komaks_newsedit/product')->getSelectedSections($this->getProduct());
            $ids = array();
    ...
    /**
     * Return distinct path ids of selected sections
     *
     * @access public
