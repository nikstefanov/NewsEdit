 ...
 */
/**
 * section - categories relation edit block
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Block_Adminhtml_Section_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('komaks_newsedit/section/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited section
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the section is linked to
     *
     * @access public
     * @return array
     * @author Ultimate Module Creator
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getSection()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param Komaks_NewsEdit_Model_Category|null $parentNodeCategory
