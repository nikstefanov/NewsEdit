 ...
 */
/**
 * Section comments admin grid block
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Block_Adminhtml_Section_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Komaks_NewsEdit_Block_Adminhtml_Section_Comment_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('komaks_newsedit/section_comment_section_collection');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'type'          => 'options',
                'options'       => array(
                    Komaks_NewsEdit_Model_Section_Comment::STATUS_PENDING  =>
                        Mage::helper('komaks_newsedit')->__('Pending'),
                    Komaks_NewsEdit_Model_Section_Comment::STATUS_APPROVED =>
                        Mage::helper('komaks_newsedit')->__('Approved'),
                    Komaks_NewsEdit_Model_Section_Comment::STATUS_REJECTED =>
     ...
     *
     * @access protected
     * @return Komaks_NewsEdit_Block_Adminhtml_Section_Grid
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access public
     * @param Komaks_NewsEdit_Model_Section_Comment
     * @return string
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access protected
     * @param Komaks_NewsEdit_Model_Resource_Section_Comment_Collection $collection
