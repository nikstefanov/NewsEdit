 ...
 */
class Komaks_NewsEdit_Block_Adminhtml_Article_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return Komaks_NewsEdit_Block_Adminhtml_Article_Edit_Tab_Product
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        ...
        $collection->joinField(
            'position',
            'komaks_newsedit/article_product',
            'position',
