 ...
 */
class Komaks_NewsEdit_Block_Adminhtml_Article_Comment_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return NewsEdit_Article_Block_Adminhtml_Article_Comment_Edit_Tab_Form
     * @author Ultimate Module Creator
     */
    protected function _prepareForm()
    {
            ...
            array(
                ...
                'after_element_html' => '<a href="'.
                    Mage::helper('adminhtml')->getUrl(
                        'adminhtml/newsedit_article/edit',
                        array(
                            'id'=>$article->getId()
                        )
                    ).
        ...
        $fieldset->addField(
            ...
            array(
                ...
                'values'   => array(
                    array(
                        'value' => Komaks_NewsEdit_Model_Article_Comment::STATUS_PENDING,
                        'label' => Mage::helper('komaks_newsedit')->__('Pending'),
                    ),
                    array(
                        'value' => Komaks_NewsEdit_Model_Article_Comment::STATUS_APPROVED,
                        'label' => Mage::helper('komaks_newsedit')->__('Approved'),
                    ),
                    array(
                        'value' => Komaks_NewsEdit_Model_Article_Comment::STATUS_REJECTED,
