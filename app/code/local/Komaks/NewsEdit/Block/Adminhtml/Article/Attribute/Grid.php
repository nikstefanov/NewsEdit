 ...
 */
class Komaks_NewsEdit_Block_Adminhtml_Article_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
    /**
     * Prepare article attributes grid collection object
     *
     * @access protected
     * @return Komaks_NewsEdit_Block_Adminhtml_Article_Attribute_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('komaks_newsedit/article_attribute_collection')
            ->addVisibleFilter();
