 ...
 */
class Komaks_NewsEdit_Block_Adminhtml_Article_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    /**
     * Adding product form elements for editing attribute
     *
     * @access protected
     * @return Komaks_NewsEdit_Block_Adminhtml_Article_Attribute_Edit_Tab_Main
     * @author Ultimate Module Creator
     */
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent(
            'komaks_newsedit_adminhtml_article_attribute_edit_prepare_form',
            array(
                'form'      => $form,
