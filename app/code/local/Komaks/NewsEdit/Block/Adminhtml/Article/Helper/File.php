 ...
 */
class Komaks_NewsEdit_Block_Adminhtml_Article_Helper_File extends Varien_Data_Form_Element_Abstract
{
    /**
     * constructor
     *
    ...
    public function getElementHtml()
    {
        ...
        if ($this->getValue()) {
            ...
            if (!preg_match("/^http\:\/\/|https\:\/\//", $url)) {
                $url = Mage::helper('komaks_newsedit/article')->getFileBaseUrl() . $url;
            }
