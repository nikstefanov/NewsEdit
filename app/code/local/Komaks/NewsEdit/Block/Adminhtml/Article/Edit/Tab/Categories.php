 ...
 */
class Komaks_NewsEdit_Block_Adminhtml_Article_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('komaks_newsedit/article/edit/tab/categories.phtml');
