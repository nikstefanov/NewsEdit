...
class Komaks_NewsEdit_Block_Adminhtml_Article_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl(
            '*/newsedit_article_widget/chooser',
        ...
        $chooser = $this->getLayout()->createBlock('widget/adminhtml_widget_chooser')
            ...
            ->setUniqId($uniqId);
        if ($element->getValue()) {
            $article = Mage::getModel('komaks_newsedit/article')->load($element->getValue());
            if ($article->getId()) {
     ...
     *
     * @access protected
     * @return Komaks_NewsEdit_Block_Adminhtml_Article_Widget_Chooser
     * @author Ultimate Module Creator
     */
    ...
    {
        return $this->getUrl(
            'adminhtml/newsedit_article_widget/chooser',
            array('_current' => true)
        );
    }
}
