 ...
 */
/**
 * Article attribute API V2 model
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Model_Article_Attribute_Api_V2 extends Komaks_NewsEdit_Model_Article_Attribute_Api
{
    /**
     * Create new article attribute
     *
     * @access public
