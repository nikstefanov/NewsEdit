 ...
 */
/**
 * Article attribute API model
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Model_Article_Attribute_Api extends Mage_Catalog_Model_Api_Resource
{
    /**
     * Article entity type id
     *
     * @var int
     */
    ...
    {
        $this->_storeIdSessionField = 'article_store_id';
        $this->_entityTypeId = Mage::getModel('eav/entity')->setType('komaks_newsedit_article')
            ->getTypeId();
    }
    ...
    {
        $attributes = Mage::getResourceModel('komaks_newsedit/article_attribute_collection');
        $result = array();
    ...
    public function options($attributeId, $store = null)
    {
        ...
        $attribute = Mage::getModel('komaks_newsedit/article')
            ->setStoreId($storeId)
            ->getResource()
