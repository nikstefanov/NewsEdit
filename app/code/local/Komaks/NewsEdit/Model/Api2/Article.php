 ...
 */
/**
 * Article REST API model
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Model_Api2_Article extends Mage_Api2_Model_Resource
{
    ...
    public function getAvailableAttributes($userType, $operation)
    {
        ...
        $entityType = Mage::getModel('eav/entity_type')->loadByCode('komaks_newsedit_article');
