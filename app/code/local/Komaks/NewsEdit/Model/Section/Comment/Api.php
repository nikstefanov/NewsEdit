 ...
 */
class Komaks_NewsEdit_Model_Section_Comment_Api extends Mage_Api_Model_Resource_Abstract
{
    /**
     * get sections comments
     *
     * @access public
     * @param mixed $filters
     * @return array
    ...
    {
        $collection = Mage::getModel('komaks_newsedit/section_comment')->getCollection();
