 ...
 */
/**
 * Section attribute API model
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Model_Section_Attribute_Api extends Mage_Catalog_Model_Api_Resource
{
    /**
     * Section entity type id
     *
     * @var int
     */
    ...
    {
        $this->_storeIdSessionField = 'section_store_id';
        $this->_entityTypeId = Mage::getModel('eav/entity')->setType('komaks_newsedit_section')
            ->getTypeId();
    }
    ...
    {
        $attributes = Mage::getResourceModel('komaks_newsedit/section_attribute_collection');
        $result = array();
        foreach ($attributes as $attribute) {
            if ($this->_isAllowedAttribute($attribute)) {
                if (!$attribute->getId() || $attribute->getIsGlobal() == Komaks_NewsEdit_Model_Attribute::SCOPE_GLOBAL) {
                    $scope = 'global';
    ...
    public function options($attributeId, $store = null)
    {
        ...
        $attribute = Mage::getModel('komaks_newsedit/section')
            ->setStoreId($storeId)
            ->getResource()
    ...
    {
        $model = Mage::getResourceModel('komaks_newsedit/eav_attribute')
