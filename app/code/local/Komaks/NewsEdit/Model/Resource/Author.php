 ...
 */
class Komaks_NewsEdit_Model_Resource_Author extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('komaks_newsedit/author', 'entity_id');
    }
     ...
     * @access protected
     * @param $object
     * @return Komaks_NewsEdit_Model_Resource_Author
     * @author Ultimate Module Creator
     */
