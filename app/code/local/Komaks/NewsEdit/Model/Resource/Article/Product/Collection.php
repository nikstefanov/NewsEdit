 ...
 */
class Komaks_NewsEdit_Model_Resource_Article_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('komaks_newsedit/article_product')),
