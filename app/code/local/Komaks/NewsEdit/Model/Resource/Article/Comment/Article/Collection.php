 ...
 */
class Komaks_NewsEdit_Model_Resource_Article_Comment_Article_Collection extends Komaks_NewsEdit_Model_Resource_Article_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('komaks_newsedit/article_comment_store');
    }
     ...
     *
     * @access protected
     * @return Komaks_NewsEdit_Model_Resource_Article_Comment_Article_Collection
     * @author Ultimate Module Creator
     */
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('komaks_newsedit/article_comment');
