 ...
 */
/**
 * Section comments resource collection model
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Model_Resource_Section_Comment_Section_Collection extends Komaks_NewsEdit_Model_Resource_Section_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('komaks_newsedit/section_comment_store');
    }
     ...
     *
     * @access protected
     * @return Komaks_NewsEdit_Model_Resource_Section_Comment_Section_Collection
     * @author Ultimate Module Creator
     */
    ...
    {
        $this->getSelect()->where('ct.section_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('komaks_newsedit/section_comment');
        $this->addAttributeToSelect('name');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.section_id = e.entity_id',
            array(
                'ct_title'      => 'title',
