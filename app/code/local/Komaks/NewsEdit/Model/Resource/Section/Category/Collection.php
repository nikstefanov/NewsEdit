 ...
 */
/**
 * Section - Category relation resource model collection
 *
 * @category    Komaks
 * @package     Komaks_NewsEdit
 * @author      Ultimate Module Creator
 */
class Komaks_NewsEdit_Model_Resource_Section_Category_Collection extends Mage_Catalog_Model_Resource_Category_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('komaks_newsedit/section_category')),
